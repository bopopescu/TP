...
#TV device information - for all tv controllers in BEMOSS
class TV(models.Model):
    tv = models.ForeignKey(DeviceMetadata, primary_key=True, max_length=50)
    ...
    def data_as_json(self):
        zone_req = Building_Zone.as_json(self.zone)
        device_info = DeviceMetadata.objects.get(device_id=self.tv_id)
