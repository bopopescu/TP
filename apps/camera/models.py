...
#camera device information - for all camera controllers in BEMOSS
class Camera(models.Model):
    camera = models.ForeignKey(DeviceMetadata, primary_key=True, max_length=50)
    ...
    def data_as_json(self):
        zone_req = Building_Zone.as_json(self.zone)
        device_info = DeviceMetadata.objects.get(device_id=self.camera_id)
