...
from apps.refrigerator.models import Refrigerator
import json
...
def refrigerator(request, mac):
    print 'inside refrigerator view method'
    ...
    print "refrigerator view for mac: {}".format(mac)
    ...
    return render_to_response(
        ...
        {'type': "refrigerator", 'mac_address': mac}, context)
