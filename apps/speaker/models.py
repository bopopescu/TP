...
#speaker device information - for all speaker controllers in BEMOSS
class Speaker(models.Model):
    speaker = models.ForeignKey(DeviceMetadata, primary_key=True, max_length=50)
    ...
    def data_as_json(self):
        zone_req = Building_Zone.as_json(self.zone)
        device_info = DeviceMetadata.objects.get(device_id=self.speaker_id)
